...
function(kbuild_add_module name)
	...
	if(kbuild_symbol_files)
		...
		add_custom_command(OUTPUT ${symvers_file}
				COMMAND cat ${kmodule_symbol_files} >> ${symvers_file}
				DEPENDS ${kmodule_symbol_files}
				)
...
# kbuild_add_objects(sources..)
#
# Build kernel object files from sources.
...
macro(kbuild_use_symbols)
	set(kbuild_symbol_files "${kmodule_symbol_files} ${ARGN}")
