...
#include <linux/mutex.h>   /* mutex-related functions */
...
#include "trace_patcher.h" /* trace event facilities */
...
static int
repl_capable(int cap)
{
	int returnValue;

	
	/* Call the target function */
	returnValue = capable(cap);



	trace_called_capable((int)cap, (int)returnValue);
...
repl___kmalloc(size_t size, gfp_t flags)
{
	...
	trace_called___kmalloc((size_t)size, (unsigned int)flags, (void*)returnValue);
...
repl_krealloc(const void* p, size_t size, gfp_t flags)
{
	...
	trace_called_krealloc((const void*)p, (size_t)size, (unsigned int)flags, (void*)returnValue);
...
repl_kmem_cache_alloc(struct kmem_cache* mc, gfp_t flags)
{
	...
	trace_called_kmem_cache_alloc((void*)mc, (unsigned int)flags, (void*)returnValue);
...
repl_kmem_cache_alloc_notrace(struct kmem_cache* mc, gfp_t flags)
{
	...
	/* Call the target function */
	returnValue = kmem_cache_alloc_notrace(mc, flags);



	trace_called_kmem_cache_alloc_notrace((void*)mc, (unsigned int)flags, (void*)returnValue);
...
repl_kmem_cache_free(struct kmem_cache* mc, void* p)
{
	...
	trace_called_kmem_cache_free((void*)mc, (void*)p);
...
repl_copy_to_user(void __user* to, void* from, unsigned long n)
{
	unsigned long returnValue;

	
	/* Call the target function */
	returnValue = copy_to_user(to, from, n);



	trace_called_copy_to_user((void __user*)to, (void*)from, (unsigned long)n, (unsigned long)returnValue);
...
static unsigned long
repl__copy_from_user(void* to, void __user* from, unsigned long n)
{
	unsigned long returnValue;

	
	/* Call the target function */
	returnValue = _copy_from_user(to, from, n);



	trace_called__copy_from_user((void*)to, (void __user*)from, (unsigned long)n, (unsigned long)returnValue);
...
static void
repl___mutex_init(struct mutex* lock, const char* name, struct lock_class_key* key)
{
	...
	trace_called___mutex_init((struct mutex*)lock, (const char*)name, (struct lock_class_key*)key);
...
repl_mutex_lock(struct mutex* lock)
{
	...
	trace_called_mutex_lock((struct mutex*)lock);
...
repl_mutex_lock_interruptible(struct mutex* lock)
{
	...
	trace_called_mutex_lock_interruptible((struct mutex*)lock, (int)returnValue);
...
repl_mutex_trylock(struct mutex* lock)
{
	...
	trace_called_mutex_trylock((struct mutex*)lock, (int)returnValue);
...
repl_mutex_unlock(struct mutex* lock)
{
	...
	trace_called_mutex_unlock((struct mutex*)lock);
...
static unsigned long
repl__raw_spin_lock_irqsave(raw_spinlock_t* lock)
{
	unsigned long returnValue;

	
	/* Call the target function */
	returnValue = _raw_spin_lock_irqsave(lock);



	trace_called__raw_spin_lock_irqsave((raw_spinlock_t*)lock, (unsigned long)returnValue);
...
static void
repl__raw_spin_unlock_irqrestore(raw_spinlock_t* lock, unsigned long flags)
{
	...
	trace_called__raw_spin_unlock_irqrestore((raw_spinlock_t*)lock, (unsigned long)flags);
...
static void* orig_addrs[] = {
	...
	(void*)&mutex_trylock,
	(void*)&mutex_unlock,
    (void*)&_raw_spin_lock_irqsave,
	(void*)&_raw_spin_unlock_irqrestore
};
...
static void* repl_addrs[] = {
    ...
    (void*)&repl___mutex_init,
	(void*)&repl_mutex_lock,
	(void*)&repl_mutex_lock_interruptible,
	(void*)&repl_mutex_trylock,
	(void*)&repl_mutex_unlock,
    (void*)&repl__raw_spin_lock_irqsave,
	(void*)&repl__raw_spin_unlock_irqrestore
};

static unsigned int num_addrs = ARRAY_SIZE(orig_addrs);
